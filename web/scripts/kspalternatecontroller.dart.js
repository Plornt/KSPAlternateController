...
main: function() {
  var loadingScene, loginScene, t1, t2, t3, t4, t5, gph, loginButton, loginTextBox, rememberPassword;
  ...
  t1 = $.Scene$("LOADING", false, false, loadingScene, null);
  $.get$scenes().push(t1);
  t1 = $.Scene$("LOGIN", false, false, loginScene, document.querySelector("#nav-LOGIN"));
  $.get$scenes().push(t1);
  t1 = $.Scene$("MAINMENU", true, true, document.querySelector("#MAINMENU"), document.querySelector("#nav-MAINMENU"));
  $.get$scenes().push(t1);
  t1 = $.Scene$("FLIGHT", true, true, document.querySelector("#FLIGHT"), document.querySelector("#nav-FLIGHT"));
  $.get$scenes().push(t1);
  t1 = $.Scene$("EDITOR", true, true, document.querySelector("#EDITOR"), document.querySelector("#nav-EDITOR"));
  $.get$scenes().push(t1);
  t1 = $.Scene$("FLAGBROWSER", false, true, document.querySelector("#FLAGBROWSER"), document.querySelector("#nav-FLAGBROWSER"));
  $.get$scenes().push(t1);
  t1 = $.serverIP;
  t2 = $.serverPort;
  t3 = $.serverPath;
  ...
  t5 = $.EventStreamProvider_click._eventType;
  t4 = new $._EventStream(loginButton, t5, false);
  $.setRuntimeTypeInfo(t4, [null]);
  new $._EventStreamSubscription(0, t4._target, t4._eventType, new $.main_closure(gph, loginButton, loginTextBox), t4._useCapture)._tryResume$0();
  t4 = document.querySelector("#MainMenu_Disconnect");
  t4.get$onClick;
  t4 = new $._EventStream(t4, t5, false);
  $.setRuntimeTypeInfo(t4, [null]);
  new $._EventStreamSubscription(0, t4._target, t4._eventType, new $.main_closure0(gph, loginButton), t4._useCapture)._tryResume$0();
  ...
  t4 = new $._EventStream(t4, t5, false);
  $.setRuntimeTypeInfo(t4, [null]);
  new $._EventStreamSubscription(0, t4._target, t4._eventType, new $.main_closure1(rememberPassword), t4._useCapture)._tryResume$0();
  t4 = document.querySelector("#MainMenu_SaveSettings");
  t4.get$onClick;
  t4 = new $._EventStream(t4, t5, false);
  $.setRuntimeTypeInfo(t4, [null]);
  new $._EventStreamSubscription(0, t4._target, t4._eventType, new $.main_closure2(loginTextBox, rememberPassword), t4._useCapture)._tryResume$0();
  t4 = document.querySelector("#MainMenu_CancelSettings");
  t4.get$onClick;
  t5 = new $._EventStream(t4, t5, false);
  $.setRuntimeTypeInfo(t5, [null]);
  new $._EventStreamSubscription(0, t5._target, t5._eventType, new $.main_closure3(), t5._useCapture)._tryResume$0();
  $.ChangeScene("LOGIN", null);
},
...
getValidExtension: function(url) {
  ...
  for (i = 0; i < 3; ++i)
    if ($.endsWith$1$s(path._path, extensions[i]))
      return extensions[i];
  return "";
},
...
OnceLoggedIn: function(gph) {
  var t1, t2, moreButton, FlagItems, processingList, flag, partCount;
  t1 = {};
  $.loggedIn = true;
  t2 = new $.WhereIterable($.get$scenes(), new $.OnceLoggedIn_closure());
  $.setRuntimeTypeInfo(t2, [null]);
  t2.forEach$1(t2, new $.OnceLoggedIn_closure0());
  moreButton = document.querySelector("#FlagBrowser_More");
  FlagItems = document.querySelector("#FlagBrowser_Items");
  processingList = $.List_List(null, [$.JSArray, $.JSString]);
  $.setRuntimeTypeInfo(processingList, [[$.JSArray, $.JSString]]);
  t1.processingList_0 = processingList;
  t1.afterID_1 = "";
  t2 = new $.OnceLoggedIn_loadMoreFlags(t1, gph, moreButton, new $.OnceLoggedIn_disableMoreButton(moreButton), new $.OnceLoggedIn_addToFlagProcessor(t1), new $.OnceLoggedIn_processFlags(t1, gph, new $.OnceLoggedIn_displayImage(FlagItems)));
  $.IterableMixinWorkaround_forEach([document.querySelector("#Editor_Flag_Image"), document.querySelector("#nav-FLAGBROWSER")], new $.OnceLoggedIn_closure1(t1, moreButton, t2));
  t1 = document.querySelector("#FlagBrowser_More");
  t1.get$onClick;
  $.EventStreamProvider_click.forTarget$2$useCapture;
  t1 = new $._EventStream(t1, $.EventStreamProvider_click._eventType, false);
  $.setRuntimeTypeInfo(t1, [null]);
  new $._EventStreamSubscription(0, t1._target, t1._eventType, new $.OnceLoggedIn_closure2(t2), t1._useCapture)._tryResume$0();
  ...
  gph.attachEvent$3$fromCache(4, new $.OnceLoggedIn_closure3(flag), true);
  gph.attachEvent$3$fromCache(5, new $.OnceLoggedIn_closure4(partCount), true);
},
...
ChangeScene: function(scene, origin) {
  var t1, E, el, t2;
  t1 = new $.WhereIterable($.get$scenes(), new $.ChangeScene_closure(scene));
  $.setRuntimeTypeInfo(t1, [null]);
  E = t1.get$first(t1);
  if (E != null) {
    el = $._FrozenElementList$_wrap(document.querySelectorAll(".active"), null);
    el.forEach$1(el, new $.ChangeScene_closure0());
    t1 = $.previousScene.style;
    t1.set$display;
    $.setProperty$3$x(t1, "display", "none", "");
    $.previousScene = E.get$scene();
    t1 = E.get$scene().style;
    t1.set$display;
    ...
    if (t2 != null) {
      t2 = $.get$classes$x(t2);
      t2.add$1(t2, "active");
      t1 = $.get$classes$x(t1.get$button(E));
      t1.remove$1(t1, "disabled");
    }
    if (origin === "KSP") {
      t1 = new $.WhereIterable($.get$scenes(), new $.ChangeScene_closure1(scene));
      $.setRuntimeTypeInfo(t1, [null]);
      t1.forEach$1(t1, new $.ChangeScene_closure2());
    }
  }
},
...
PacketHandler_getPacketFromType: function(n, d) {
  ...
  switch (n) {
    ...
    case 6:
      ...
      t2 = t1.$index(d, "ID");
      t1 = t1.$index(d, "Vessels");
      p = new $.RequestAllVesselDataServer(6, null, "", 0);
      p.responseID = t2;
      p.vesselObjects = t1;
      break;
    case 7:
...
CustomEvent: {"": "Object;eventNum<",
  subscriptions$1: function(subID) {
    return this._eventFunctions._length;
  },
...
main_closure: {"": "Closure;gph_0,loginButton_1,loginTextBox_2",
  call$1: function(t) {
    var t1, t2;
    t1 = this.loginButton_1;
    $.set$disabled$x(t1, true);
    t2 = this.gph_0;
    t2.connect$2$onClose(new $.main__closure(t2, t1, this.loginTextBox_2), new $.main__closure0(t2, t1));
  }
},

main__closure: {"": "Closure;gph_3,loginButton_4,loginTextBox_5",
  call$0: function() {
    var t1 = this.gph_3;
    t1.sendAwaitResponse$1(new $.SendPasswordPacket(1, "tempPass", null, null)).then$1(new $.main___closure(t1, this.loginButton_4, this.loginTextBox_5));
  }
},

main___closure: {"": "Closure;gph_6,loginButton_7,loginTextBox_8",
  call$1: function(response) {
    var t1;
    if (response.get$packetID() === 2) {
      t1 = this.gph_6;
      ...
      if ($.$eq(t1.$index(t1, "settings_rememberPassword"), "true")) {
        t1 = $.get$settings();
        t1.$indexSet(t1, "settings_password", $.get$value$x(this.loginTextBox_8));
      }
    } else {
      window.alert("The password you entered was incorrect");
      $.set$disabled$x(this.loginButton_7, false);
    }
  }
},

main__closure0: {"": "Closure;gph_9,loginButton_10",
  call$0: function() {
    var t1 = this.gph_9;
    $.Primitives_printString("WE CLOSED IT?");
    t1._detachAllEvents$0();
    t1.ws.close();
    $.ChangeScene("LOGIN", null);
    $.set$disabled$x(this.loginButton_10, false);
  }
},

main_closure0: {"": "Closure;gph_11,loginButton_12",
  call$1: function(t) {
    var t1 = this.gph_11;
    $.Primitives_printString("WE CLOSED IT?");
    t1._detachAllEvents$0();
...
main_closure1: {"": "Closure;rememberPassword_13",
  call$1: function(t) {
    ...
    t1 = $.get$settings();
    $.set$checked$x(this.rememberPassword_13, $.$eq(t1.$index(t1, "settings_rememberPassword"), "true"));
  }
},

main_closure2: {"": "Closure;loginTextBox_14,rememberPassword_15",
  call$1: function(t) {
    var t1, t2, t3;
    $.Primitives_printString("SAVED");
    t1 = $.get$settings();
    t2 = this.rememberPassword_15;
    t3 = $.getInterceptor$x(t2);
    t1.$indexSet(t1, "settings_rememberPassword", $.toString$0(t3.get$checked(t2)));
    if (t3.get$checked(t2) === true) {
      t1 = $.get$settings();
      t1.$indexSet(t1, "settings_password", $.get$value$x(this.loginTextBox_14));
    } else {
      t1 = $.get$settings();
...
OnceLoggedIn_closure: {"": "Closure;",
  call$1: function(E) {
    return $.get$button$x(E) != null && E.get$needsLogin() === true && E.get$buttonDisableOnChange() === false;
  }
},

OnceLoggedIn_closure0: {"": "Closure;",
  call$1: function(E) {
    var t1 = $.get$classes$x($.get$button$x(E));
    t1.remove$1(t1, "disabled");
  }
},

OnceLoggedIn_disableMoreButton: {"": "Closure;moreButton_1",
  call$0: function() {
    var t1, t2;
    t1 = this.moreButton_1;
...
OnceLoggedIn_addToFlagProcessor: {"": "Closure;box_0",
  call$4: function(path, author, score, title) {
    this.box_0.processingList_0.push([path, author, score, title]);
  }
},

OnceLoggedIn_displayImage: {"": "Closure;FlagItems_2",
  call$4: function(image, author, score, title) {
    var imContainer, caption, CaptionTitle, text, scoreElement, buttons, button, t1, t2;
    imContainer = document.createElement("div");
    caption = document.createElement("div");
    CaptionTitle = document.createElement("h4");
    text = document.createElement("p");
    scoreElement = document.createElement("p");
    buttons = document.createElement("p");
    button = document.createElement("link");
    t1 = $.getInterceptor$x(imContainer);
    t2 = t1.get$classes(imContainer);
    t2.add$1(t2, "thumbnail");
    t1 = t1.get$classes(imContainer);
    t1.add$1(t1, "thmbwidth");
    $.set$innerHtml$x(CaptionTitle, title);
    $.set$innerHtml$x(text, "Created by " + $.S(author));
    $.set$innerHtml$x(scoreElement, "Score: " + $.S(score));
    t1 = $.get$classes$x(buttons);
    t1.add$1(t1, "alignBottom");
    t1 = $.getInterceptor$x(button);
    t2 = t1.get$classes(button);
    t2.add$1(t2, "btn");
    t2 = t1.get$classes(button);
    t2.add$1(t2, "btn-primary");
    t2 = t1.get$classes(button);
    t2.add$1(t2, "btn-block");
    t1.set$innerHtml(button, "Import");
    buttons.appendChild(button);
    caption.appendChild(CaptionTitle);
    caption.appendChild(text);
    caption.appendChild(scoreElement);
    caption.appendChild(buttons);
    imContainer.appendChild(image);
    imContainer.appendChild(caption);
    this.FlagItems_2.appendChild(imContainer);
  }
},

OnceLoggedIn_processFlags: {"": "Closure;box_0,gph_3,displayImage_4",
  call$0: function() {
    $.IterableMixinWorkaround_forEach(this.box_0.processingList_0, new $.OnceLoggedIn_processFlags_closure(this.gph_3, this.displayImage_4));
  }
},

OnceLoggedIn_processFlags_closure: {"": "Closure;gph_5,displayImage_6",
  call$1: function(currentComment) {
    var path = $.$index$asx(currentComment, 0);
    this.gph_5.sendAwaitResponse$1(new $.GetCrossOriginHTML(6, path, null, null)).then$1(new $.OnceLoggedIn_processFlags__closure(this.displayImage_6, currentComment, path));
  }
},

OnceLoggedIn_processFlags__closure: {"": "Closure;displayImage_7,currentComment_8,path_9",
  call$1: function(response) {
    var im, t1, exception;
    if (response.get$base64() === true)
      try {
        ...
        t1 = $.get$onLoad$x(im);
        new $._EventStreamSubscription(0, t1._target, t1._eventType, new $.OnceLoggedIn_processFlags___closure(this.displayImage_7, this.currentComment_8, im), t1._useCapture)._tryResume$0();
      } catch (exception) {
        $.unwrapException(exception);
        $.Primitives_printString("Invalid: " + $.S(this.path_9));
      }

  }
},

OnceLoggedIn_processFlags___closure: {"": "Closure;displayImage_10,currentComment_11,im_12",
  call$1: function(t) {
    var t1, t2, t3;
    t1 = this.im_12;
    t2 = $.getInterceptor$x(t1);
    if (t2.get$width(t1) === 256)
      if (t2.get$height(t1) === 160) {
        t2 = this.currentComment_11;
        t3 = $.getInterceptor$asx(t2);
        this.displayImage_10.call$4(t1, t3.$index(t2, 1), t3.$index(t2, 2), t3.$index(t2, 3));
      }
  }
},

OnceLoggedIn_loadMoreFlags: {"": "Closure;box_0,gph_13,moreButton_14,disableMoreButton_15,addToFlagProcessor_16,processFlags_17",
  call$0: function() {
    var t1, t2;
    t1 = this.moreButton_14;
    $.set$disabled$x(t1, true);
    t2 = this.box_0;
    this.gph_13.sendAwaitResponse$1(new $.GetCrossOriginHTML(6, "http://www.reddit.com/r/KSPFlags/top.json?t=all&after=" + $.S(t2.afterID_1) + "&limit=15", null, null)).then$1(new $.OnceLoggedIn_loadMoreFlags_closure(t2, t1, this.disableMoreButton_15, this.addToFlagProcessor_16, this.processFlags_17));
  }
},

OnceLoggedIn_loadMoreFlags_closure: {"": "Closure;box_0,moreButton_18,disableMoreButton_19,addToFlagProcessor_20,processFlags_21",
  call$1: function(response) {
    var json, processingList, t1, exception;
      ...
      if ($.$eq($.$index$asx(json, "kind"), "Listing"))
        if ($.$index$asx(json, "data") != null) {
          if ($.$index$asx($.$index$asx(json, "data"), "children") != null)
            $.forEach$1$ax($.$index$asx($.$index$asx(json, "data"), "children"), new $.OnceLoggedIn_loadMoreFlags__closure(this.addToFlagProcessor_20));
          else
            this.disableMoreButton_19.call$0();
          t1.afterID_1 = $.$index$asx($.$index$asx(json, "data"), "after");
        } else
          this.disableMoreButton_19.call$0();
      else
        this.disableMoreButton_19.call$0();
      $.set$disabled$x(this.moreButton_18, false);
      this.processFlags_21.call$0();
    } catch (exception) {
      $.unwrapException(exception);
      this.disableMoreButton_19.call$0();
    }
...
OnceLoggedIn_loadMoreFlags__closure: {"": "Closure;addToFlagProcessor_22",
  call$1: function(val) {
    var post;
    if ($.$eq($.$index$asx(val, "kind"), "t3"))
      if ($.$index$asx(val, "data") != null) {
        ...
        this.addToFlagProcessor_22.call$4($.imgurAddExtension($.$index$asx(post, "url")), $.$index$asx(post, "author"), $.toString$0($.$index$asx(post, "score")), $.$index$asx(post, "title"));
      }
  }
},

OnceLoggedIn_closure1: {"": "Closure;box_0,moreButton_23,loadMoreFlags_24",
  call$1: function(E) {
    var t1 = $.get$onClick$x(E);
    new $._EventStreamSubscription(0, t1._target, t1._eventType, new $.OnceLoggedIn__closure(this.box_0, this.moreButton_23, this.loadMoreFlags_24), t1._useCapture)._tryResume$0();
  }
},

OnceLoggedIn__closure: {"": "Closure;box_0,moreButton_25,loadMoreFlags_26",
  call$1: function(t) {
    var t1;
    $.ChangeScene("FLAGBROWSER", null);
    t1 = this.moreButton_25;
    if (t1 != null)
      $.set$value$x(t1, "View More");
    if ($.$eq(this.box_0.afterID_1, ""))
      this.loadMoreFlags_26.call$0();
  }
},

OnceLoggedIn_closure2: {"": "Closure;loadMoreFlags_27",
  call$1: function(ev) {
    this.loadMoreFlags_27.call$0();
  }
},

OnceLoggedIn_closure3: {"": "Closure;flag_28",
  call$1: function(ev) {
    $.Primitives_printString("Received flag update");
    $.set$src$x(this.flag_28, "data:image/png;base64," + $.S(ev.get$base64Flag()));
  }
},

OnceLoggedIn_closure4: {"": "Closure;partCount_29",
  call$1: function(ev) {
    $.Primitives_printString("Part update");
    $.set$innerHtml$x(this.partCount_29, $.toString$0(ev.get$partCount()));
  }
},
...
loadSettings_closure: {"": "Closure;",
  call$2: function(key, value) {
    var t1;
    if ($.startsWith$1$s(key, "settings_")) {
      t1 = $.get$settings();
...
Scene: {"": "Object;name>,buttonDisableOnChange<,needsLogin<,scene<,button>",
  Scene$5: function($name, buttonDisableOnChange, needsLogin, scene, button) {
    var t1, t2;
    $.Primitives_printString("Added");
    t1 = this.button;
    if (t1 != null) {
      t1.get$onClick;
      $.EventStreamProvider_click.forTarget$2$useCapture;
      t2 = new $._EventStream(t1, $.EventStreamProvider_click._eventType, false);
      $.setRuntimeTypeInfo(t2, [null]);
      new $._EventStreamSubscription(0, t2._target, t2._eventType, new $.Scene_closure(this), t2._useCapture)._tryResume$0();
      if (this.needsLogin === true) {
        t2 = $.get$classes$x(t1);
        t2.add$1(t2, "disabled");
      }
      if (this.buttonDisableOnChange === true) {
        t1 = $.get$classes$x(t1);
  ...
  static: {
Scene$: function($name, buttonDisableOnChange, needsLogin, scene, button) {
  var t1 = new $.Scene($name, buttonDisableOnChange, needsLogin, scene, button);
  t1.Scene$5($name, buttonDisableOnChange, needsLogin, scene, button);
  return t1;
}}

},

Scene_closure: {"": "Closure;this_0",
  call$1: function(ev) {
    var t1, t2, t3;
    t1 = this.this_0;
    t2 = $.getInterceptor$x(t1);
    t3 = $.get$classes$x(t2.get$button(t1));
    t3.contains$1;
    t3 = t3.readClasses$0();
    if (!t3.contains$1(t3, "disabled"))
      $.ChangeScene(t2.get$name(t1), null);
  }
},
...
SetupSceneHandler_closure: {"": "Closure;",
  call$1: function($event) {
    switch ($event.get$sceneName()) {
      case "LOADING":
        $.ChangeScene("LOADING", "KSP");
        break;
      case "MAINMENU":
        $.ChangeScene("MAINMENU", "KSP");
        break;
      case "FLIGHT":
        $.ChangeScene("FLIGHT", "KSP");
        break;
      case "EDITOR":
        $.ChangeScene("EDITOR", "KSP");
        break;
    }
  }
},

ChangeScene_closure: {"": "Closure;scene_0",
  call$1: function(S) {
    return $.$eq($.get$name$x(S), this.scene_0);
  }
},

ChangeScene_closure0: {"": "Closure;",
  call$1: function(e) {
...
ChangeScene_closure1: {"": "Closure;scene_1",
  call$1: function(S) {
    var t1;
    if (S.get$buttonDisableOnChange() === true) {
      t1 = $.getInterceptor$x(S);
      t1 = !$.$eq(t1.get$name(S), this.scene_1) && t1.get$button(S) != null;
    } else
      t1 = false;
    if (!t1)
      t1 = !$.loggedIn && $.get$button$x(S) != null && S.get$needsLogin() === true;
    else
      t1 = true;
    return t1;
  }
...
ResponsePacket: {"": "Packet;",
  messageHandlerHandlePacket$1: function(gph) {
    var t1 = gph.get$awaitingResponses();
    if (t1.containsKey$1(t1, this.responseID)) {
      t1 = gph.get$awaitingResponses();
      $.complete$1$x(t1.$index(t1, this.responseID), this);
    }
...
GlobalProgramHandler: {"": "Object;ws,sIP,sPort,sPath,messageHandler,eventList,awaitingResponses<",
  ...
  connect$2$onClose: function(onOpen, onClose) {
    ...
    $.setRuntimeTypeInfo(t1, [null]);
    new $._EventStreamSubscription(0, t1._target, t1._eventType, new $.GlobalProgramHandler_connect_closure(this), t1._useCapture)._tryResume$0();
    t1 = this.ws;
    t1.get$onClose;
    $.EventStreamProvider_close.forTarget$2$useCapture;
    t1 = new $._EventStream(t1, $.EventStreamProvider_close._eventType, false);
    $.setRuntimeTypeInfo(t1, [null]);
    new $._EventStreamSubscription(0, t1._target, t1._eventType, new $.GlobalProgramHandler_connect_closure0(), t1._useCapture)._tryResume$0();
    t1 = this.ws;
    t1.get$onError;
    $.EventStreamProvider_error.forTarget$2$useCapture;
    t1 = new $._EventStream(t1, $.EventStreamProvider_error._eventType, false);
    $.setRuntimeTypeInfo(t1, [null]);
    new $._EventStreamSubscription(0, t1._target, t1._eventType, new $.GlobalProgramHandler_connect_closure1(), t1._useCapture)._tryResume$0();
    t1 = this.ws;
    t1.get$onOpen;
    $.EventStreamProvider_open.forTarget$2$useCapture;
    t1 = new $._EventStream(t1, $.EventStreamProvider_open._eventType, false);
    $.setRuntimeTypeInfo(t1, [null]);
    new $._EventStreamSubscription(0, t1._target, t1._eventType, new $.GlobalProgramHandler_connect_closure2(onOpen), t1._useCapture)._tryResume$0();
  },
...
GlobalProgramHandler_connect_closure0: {"": "Closure;",
  call$1: function(e) {
    ...
    $.Primitives_printString("Closed because closed. " + t1.get$reason(e) + " " + $.S(t1.get$code(e)));
    $.Window_methods.open$2(window, $.toString$0($.Window_methods.get$location(window)), "");
  }
},
...
Uuid: {"": "Object;_rndBytes,_seedBytes,_nodeId,_clockSeq,_lastMSecs,_lastNSecs,_byteToHex,_hexToByte",
  ...
  v1$3$buffer$offset$options: function(buffer, offset, options) {
    ...
    t3 = $.$sub$n(nSecs, this._lastNSecs);
    if (typeof t3 !== "number")
      throw t3.$div();
    dt = $.$add$ns(t2, t3 / 10000);
    t2 = $.getInterceptor$n(dt);
    if (t2.$lt(dt, 0) && options.$index(options, "clockSeq") == null) {
      t3 = $.$add$ns(clockSeq, 1);
      if (typeof t3 !== "number")
        throw t3.$and();
      clockSeq = t3 & 16383;
    }
    if ((t2.$lt(dt, 0) || t1.$gt(mSecs, this._lastMSecs)) && options.$index(options, "nSecs") == null)
      nSecs = 0;
    if ($.$ge$n(nSecs, 10000))
    ...
    if (typeof nSecs !== "number")
      throw $.iae(nSecs);
    tl = $.JSNumber_methods.$mod((mSecs & 268435455) * 10000 + nSecs, 4294967296);
    i = offset + 1;
    t1 = $.JSNumber_methods.$shr(tl, 24);
    if (offset < 0 || offset >= 16)
      throw $.ioore(offset);
    buf[offset] = t1 & 255;
    i0 = i + 1;
    t1 = $.JSNumber_methods.$shr(tl, 16);
    if (i < 0 || i >= 16)
      throw $.ioore(i);
    buf[i] = t1 & 255;
    i = i0 + 1;
    t1 = $.JSNumber_methods.$shr(tl, 8);
    if (i0 < 0 || i0 >= 16)
      throw $.ioore(i0);
    buf[i0] = t1 & 255;
    i0 = i + 1;
    if (i < 0 || i >= 16)
      throw $.ioore(i);
    buf[i] = tl & 255;
    tmh = $.JSNumber_methods.$tdiv(mSecs, 4294967296) * 10000 & 268435455;
    i = i0 + 1;
    t1 = $.JSInt_methods.$shr(tmh, 8);
    if (i0 < 0 || i0 >= 16)
      throw $.ioore(i0);
    buf[i0] = t1 & 255;
    i0 = i + 1;
    ...
    buf[i] = tmh & 255;
    i = i0 + 1;
    t1 = $.JSInt_methods.$shr(tmh, 24);
    if (i0 < 0 || i0 >= 16)
      throw $.ioore(i0);
    buf[i0] = (t1 & 15 | 16) >>> 0;
    i0 = i + 1;
    t1 = $.JSInt_methods.$shr(tmh, 16);
    if (i < 0 || i >= 16)
      throw $.ioore(i);
    buf[i] = t1 & 255;
    i = i0 + 1;
    if (typeof clockSeq !== "number")
      throw clockSeq.$shr();
    t1 = $.JSNumber_methods.$shr(clockSeq, 8);
    if (i0 < 0 || i0 >= 16)
      throw $.ioore(i0);
    buf[i0] = (t1 | 128) >>> 0;
    i0 = i + 1;
    ...
    if (typeof node !== "string" && (typeof node !== "object" || node === null || node.constructor !== Array && !$.isJsIndexable(node, node[$.dispatchPropertyName])))
      return this.v1$3$buffer$offset$options$bailout(1, buffer, buf, i0, node);
  ...
  v1$3$buffer$offset$options$bailout: function(state0, buffer, buf, i0, node) {
    var t1, n, t2, t3;
...
Uri: {"": "Object;_liblib0$_port,_path,scheme,userInfo,host,query,fragment,_pathSegments,_queryParameters",
  ...
  _writeAuthority$1: function(ss) {
    ...
    if (t1 == null)
      ...
      t1 = "[" + $.S(t1) + "]";
    ss.write$1(t1);
    if (!$.$eq(this._liblib0$_port, 0)) {
      ss.write$1(":");
      ss.write$1($.toString$0(this._liblib0$_port));
    }
  },
  toString$0: function(_) {
    var sb, t1;
  ...
  $eq: function(_, other) {
    ...
    if (typeof other !== "object" || other === null || !$.getInterceptor(other).$isUri)
      return false;
    return $.$eq(this.scheme, other.scheme) && $.$eq(this.userInfo, other.userInfo) && $.$eq(this.host, other.host) && $.$eq(this._liblib0$_port, other.get$port(other)) && $.$eq(this._path, other.get$path(other)) && $.$eq(this.query, other.query) && $.$eq(this.fragment, other.fragment);
  },
  get$hashCode: function(_) {
    var t1 = new $.Uri_hashCode_combine();
    return t1.call$2(this.scheme, t1.call$2(this.userInfo, t1.call$2(this.host, t1.call$2(this._liblib0$_port, t1.call$2(this._path, t1.call$2(this.query, t1.call$2(this.fragment, 1)))))));
  },
...
_MultiElementCssClassSet: {"": "CssClassSetImpl;_elementIterable,_elementCssClassSetIterable",
  ...
  writeClasses$1: function(s) {
    ...
    for (t1 = this._elementIterable, t1 = new $.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();)
      $.set$className$x(t1._current, classes);
  },
  modify$1: function(f) {
...
_ElementCssClassSet: {"": "CssClassSetImpl;_element",
  readClasses$0: function() {
    ...
    s = new $.LinkedHashSet(0, null, null, null, null, null, 0);
    $.setRuntimeTypeInfo(s, [$.JSString]);
    for (t1 = $.get$className$x(this._element).split(" "), t1 = new $.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();) {
...
AnchorElement: {"": "_HTMLElement;hostname=,name=",
  toString$0: function(receiver) {
...
ButtonElement: {"": "_HTMLElement;disabled},name=,value%"},

CanvasElement: {"": "_HTMLElement;height=,width="},

CharacterData: {"": "Node;data=,length="},

CloseEvent: {"": "Event;code=,reason="},
...
Element: {"": "Node;innerHtml:innerHTML},className%,$$dom_children:children=",
  get$children: function(receiver) {
...
InputElement: {"": "_HTMLElement;checked%,disabled},height=,name=,src},value%,width=", $isElement: true, $asElement: null, $isNode: true, $asNode: null},

KeygenElement: {"": "_HTMLElement;disabled},name="},

LIElement: {"": "_HTMLElement;value%"},

LinkElement: {"": "_HTMLElement;disabled}"},
...
ObjectElement: {"": "_HTMLElement;code=,data=,height=,name=,width="},
...
StyleElement: {"": "_HTMLElement;disabled}"},
...
_ListRange: {"": "IterableBase;_liblib6$_source,_offset,_liblib6$_length",
  ...
  _ListRange$3: function(source, offset, $length) {
    ...
    t1 = this._offset;
    t2 = $.getInterceptor$n(t1);
    if (t2.$lt(t1, 0) || t2.$gt(t1, $.get$length$asx(this._liblib6$_source)))
    ...
    if ($.$gt$n(t3.$add(t2, t1), $.get$length$asx(this._liblib6$_source)))
...
Isolate.$lazy($, "scenes", "scenes", "get$scenes", function() {
  var t1 = $.List_List(null, $.Scene);
  $.setRuntimeTypeInfo(t1, [$.Scene]);
  return t1;
});
...
$.defineNativeMethods("AudioProcessingEvent|BeforeLoadEvent|CSSFontFaceLoadEvent|CustomEvent|DeviceMotionEvent|DeviceOrientationEvent|ErrorEvent|HashChangeEvent|IDBVersionChangeEvent|MIDIConnectionEvent|MediaKeyEvent|MediaKeyMessageEvent|MediaKeyNeededEvent|MediaStreamEvent|MediaStreamTrackEvent|MutationEvent|OfflineAudioCompletionEvent|OverflowEvent|PageTransitionEvent|PopStateEvent|ProgressEvent|RTCDTMFToneChangeEvent|RTCDataChannelEvent|RTCIceCandidateEvent|ResourceProgressEvent|SecurityPolicyViolationEvent|SpeechInputEvent|SpeechRecognitionError|SpeechRecognitionEvent|StorageEvent|TrackEvent|TransitionEvent|WebGLContextEvent|WebKitAnimationEvent|WebKitTransitionEvent|XMLHttpRequestProgressEvent", $.Event);
